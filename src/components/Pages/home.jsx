                    ...
                    <Nav/>
                        ...
                        <div className='row'>
                            <div className='featured col'>
                                <div className='row'>
                                    <div className='col-lg-1'><i className=" featured__arrow featured__arrow-left fas fa-arrow-left" /></div>
                                    <Featured className='featured' products={this.state.products}/>
                                    <div className='col-lg-1'><i className=" featured__arrow featured__arrow-right fas fa-arrow-right" /></div>
                                </div>
                            </div>
                        </div>
